...
public class methodoverloading01 {
    ...
    Static methodları çağirmak için nesne oluşturmaya gerek yok Static nethodlar classa özgü bür defa oluşur
    Static methodlara sınıf ismi üzerinden erişilebilir non staticte obje üzerinden
     */
